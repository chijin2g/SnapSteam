  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 pb-12">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 font-medium tracking-wide">INTELLIGENT STEAM TABLES</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {error && (
          <div className="mb-6 bg-red-900/30 border-l-4 border-red-500 p-4 rounded-md shadow-sm">
            <div className="flex">
